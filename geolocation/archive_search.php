...
<div class="container">
            ...
            <div class="pull-right">
                <div class="btn-group">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 navbar_kin ">
                        <h1 class="h1 mb-0 text-gray-800 font_kin" style="color:white; margin-left:-35px; margin-top:-20px;">Archive Reports<span style="color:red;">!</span></h1>
    ...
    <div id="products" class="row view-group navbar_kin" style="margin-top:-10px;">
    	        		<?php
	$row = mysqli_query($conn, "SELECT * FROM tb_data WHERE status='Accepted' AND emer_loc = '$search' ORDER BY id DESC");
?>
