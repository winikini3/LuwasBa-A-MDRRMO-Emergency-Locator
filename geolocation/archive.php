...
<div class="container">
            ...
            <div class="pull-right">
                <div class="btn-group">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 navbar_kin ">
                        <h1 class="h1 mb-0 text-gray-800 font_kin" style="color:white; margin-left:-35px; margin-top:-20px;">Reports Archive<span style="color:red;">!</span></h1>
                        <form action="archive_search.php" method="get" class="d-flex" style="margin-right:-40px; margin-top:10px;">
    ...
    <div id="products" class="row view-group navbar_kin" style="margin-top:-10px;">
    	        		<?php
	$row = mysqli_query($conn, "SELECT * FROM tb_data WHERE status='Accepted' ORDER BY id DESC");
...
<div class="item col-xs-4 col-lg-4 mt-2 search-result">
    <div class="thumbnail card" style="background-color: #13205A; color:white;">
        ...
        <div class="caption card-body">
            <h4 class="group card-title inner list-group-item-heading" style="font-size:27px;">
