				...
				<tr>
					...
					<td class="zoom"> <img src="img/<?php echo $row["image"]; ?>" width = 200 title="<?php echo $row['image']; ?>"> </td>
					      <td style="padding-left:15px;"> 
					      	<button type="button" class="btn btn-success updatebtn" style="padding:10px 20px;">ACCEPT</button>	
                            <button type="button" class="btn btn-danger rejectbtn"style="padding:10px 24px;">REJECT</button>
