...
<body id="page-top">
 ...
 <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h1 mb-0 ml-3 text-gray-800">Emergency Request History</h1>
                    </div>
...
<table class="table-data table-responsive">
  <thead>
    <tr>
      ...
      <th scope="col" style="color:  #1B3061;"><b>Status</th>
    </tr>
  </thead>
				<?php
			  ...
			  <tbody class="table-group-divider">
				<tr>
					...
					<td><b><?php echo $row["status"]; ?> / <?php echo $row["status1"]; ?></td> 
					      <td> 
