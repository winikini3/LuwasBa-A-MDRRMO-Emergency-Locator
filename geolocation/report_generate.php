...
$daily_sql = "SELECT DATE(date) as day, COUNT(*) as count FROM tb_data WHERE status='Accepted' GROUP BY DATE(date)";
$daily_result = $conn->query($daily_sql);

$location_sql = "SELECT emer_loc, COUNT(*) as count FROM tb_data WHERE status='Accepted' GROUP BY emer_loc ORDER BY count DESC";
$location_result = $conn->query($location_sql);

$type_sql = "SELECT emer_type, COUNT(*) as count FROM tb_data WHERE status='Accepted' GROUP BY emer_type ORDER BY count DESC";
