...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <body>
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 navbar_kin font_kin mt-3">
                        <h1 class="h1 text-gray-800" style="color:white; margin-left:10px; margin-bottom:90px;">Data Analytics</h1>
    ...
    chart2.draw(data2, google.charts.Bar.convertOptions(options2));
                                ...
                                <div class="card-body">
                                    <div class="chart-area" >
                                            <div class="container-fluid mt-3" id="barchart_material" style="width: 100%; height: 330px; "></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-5 " >
                            <div class="card shadow" style="margin-left: 14px; margin-right: -27px;">
                                <!-- Card Header - Dropdown -->
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                ...
                                <div class="card-body">
                                    <div>
                                        <div class="container-fluid mt-3" id="chart_div" style="width: 389px; height: 300px; margin-left:-29px;"></div>
                                    </div>
